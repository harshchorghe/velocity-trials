    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", marginBottom: "8px" }}>
          ...
          >
            LEVEL 2 CLEARED! {rankText && <span style={{ color: "#38bdf8" }}>QUALIFIED {rankText}</span>}
          </h1>
        </div>

        <p style={{ color: "#cbd5e1", fontSize: "14px", margin: "0 0 20px 0" }}>
          Congratulations <strong>{player.name}</strong>! You qualified for <strong>Level 3</strong>.
        </p>
        ...
        >
          ...
          <div style={{ textAlign: "center" }}>
            <div style={{ fontSize: "11px", color: "#94a3b8", fontWeight: 600 }}>LIVES REMAINING</div>
            <div style={{ fontSize: "18px", fontWeight: 800, color: "#ef4444", marginTop: "4px" }}>
              {player.lives} ❤️
            </div>
          </div>
          <div style={{ textAlign: "center" }}>
            <div style={{ fontSize: "11px", color: "#94a3b8", fontWeight: 600 }}>TIME TAKEN</div>
