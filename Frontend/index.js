...
async function handleStartMission(e) {
    ...
    try {
        ...
        const currentLvl = res.session?.currentLevel || 1;
        runAuthSequence(n, agId, d, y, currentLvl);
    } catch (err) {
        AUDIO.sfxError();
        showAlert(
            'error',
...
function proceedToLevel2() { window.location.href = './level2.html'; }
function proceedToLevel3() { window.location.href = './level3.html'; }
